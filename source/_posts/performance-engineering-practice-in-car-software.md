...
尝试落地持续性能优化的过程中，最困难的部分就是建立评估模型，因为评估模型代表性能目标。（关于评估模型的建立，请参考[《智能座舱软件性能与可靠性的评估和改进》](https://mp.weixin.qq.com/s/ryVSbr32NsAzURjWjsh53g)）
...
*图源：*[*Organizing Agile Teams and ARTs: Team Topologies at Scale*](https://scaledagileframework.com/organizing-agile-teams-and-arts-team-topologies-at-scale/)
...
当然一步到位的组建出这样的“六边形”团队不是件容易的事，但组织只要尝试开始构建性能工程，相信最初不胜任的团队，其能力也会随着[性能工程成熟度](https://mp.weixin.qq.com/s/k6Ow_dfZxl8mhdYvTM9TrA)的不断提升，而最终成为胜任的团队。
